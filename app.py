...
st.subheader('Data from 2014 - 2025')
...
fig = plt.figure(figsize=(12,6))
plt.plot(ma100, 'r', label = 'Short-term Moving Average (100MA)')
...
fig = plt.figure(figsize=(12,6))
plt.plot(ma100, 'r', label = 'Short-term Moving Average (100MA)')
plt.plot(ma200, 'g', label = 'Long-term Moving Average (200MA)')
plt.plot(df.Close, 'b', label = 'Closing Price')
plt.legend()
plt.xlabel('Trend in Years')
plt.ylabel('Price')
